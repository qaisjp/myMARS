...
//       }
     ...
     */
    private void setOrigin(int firstLine, int horizontalOffset) {
   ...
   /* Use painter's cached info for speed */
     ...
     */
    final void setTokenMarker(TokenMarker tokenMarker) {
